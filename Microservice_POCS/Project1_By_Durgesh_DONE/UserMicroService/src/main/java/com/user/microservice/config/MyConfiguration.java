...
import com.user.microservice.config.interceptors.RestTemplateInteceptor;
...
public class MyConfiguration {
	...
	public RestTemplate restTemplate() {
		...
		interceptors.add(
				new RestTemplateInteceptor(manager(clientRegistrationRepository, oAuth2AuthorizedClientRepository)));
