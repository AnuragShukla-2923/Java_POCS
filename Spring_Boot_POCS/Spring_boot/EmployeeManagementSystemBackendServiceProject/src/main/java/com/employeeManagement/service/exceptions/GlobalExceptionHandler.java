...
//	@ExceptionHandler(com.mysql.cj.jdbc.exceptions.CommunicationsException.class)
//	public ResponseEntity<ApiResponse> communicationsExceptionHandler(
...
//	}
//	
//	@ExceptionHandler(com.mysql.cj.exceptions.CJCommunicationsException.class)
//	public ResponseEntity<ApiResponse> cJCommunicationsExceptionHandler(
//			CJCommunicationsException ex) {
//		String message = "Database connection failure";
//		ApiResponse apiResponse = new ApiResponse(message, false);
//		return new ResponseEntity<ApiResponse>(apiResponse, HttpStatus.NOT_ACCEPTABLE);
//	}
