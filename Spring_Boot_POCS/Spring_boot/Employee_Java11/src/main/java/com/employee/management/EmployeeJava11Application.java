...
public class EmployeeJava11Application  implements CommandLineRunner{
	...
	@Autowired
	private UserRepo userRepo;	public static void main(String[] args) {
		SpringApplication.run(EmployeeJava11Application.class, args);
	}
