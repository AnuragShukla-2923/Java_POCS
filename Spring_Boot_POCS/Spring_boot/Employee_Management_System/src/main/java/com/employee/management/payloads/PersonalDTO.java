...
//	@Pattern(regexp = "^[a-zA-Z]{2,12}$", message = "Incorrect First Name,Only 2-12 letters are allowed!")
	private String firstName;
//	@Pattern(regexp = "^([a-zA-Z]{2,12})$|^()$", message = "Incorrest Second Name,Only 2-12 letters or blank value is allowed!")
	private String secondName;
//	@Pattern(regexp = "^[a-zA-Z]{2,12}$", message = "Incorrect last Name,can be 2-12 letters only")
	private String lastName;

//	@Age(message = "Age must be in between 20 to 50 years")
	private int age;
...
//	@Pattern(regexp = "^[a-zA-Z0-9 \\,\\-]{4,30}$",message = "Invalid Address")
