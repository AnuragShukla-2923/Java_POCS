...
public class Accommodation_Tab_Controller {
...
//	//@Requestpart is creating problem At front end.
//	//create
//	@PostMapping("/create")
...
//	}
	...
	public ResponseEntity<AccommodationTabDto>createAccommodationDetails(@RequestBody AccommodationTabDto accommodationTabDto,
		...
		AccommodationTabDto createdAccommodationDetails = this.accommodationTab_Service.createAccommodationDetails(accommodationTabDto,pid);
		return new ResponseEntity<AccommodationTabDto>(createdAccommodationDetails,HttpStatus.OK);
	}
