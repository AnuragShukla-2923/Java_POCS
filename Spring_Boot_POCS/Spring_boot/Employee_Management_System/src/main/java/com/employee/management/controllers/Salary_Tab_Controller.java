...
import com.employee.management.services.SalaryTab_Service;
...
//	}
	...
	public ResponseEntity<SalaryTabDto>createSalary(@RequestBody SalaryTabDto salaryTabDto,
			@PathVariable Long pid){
		SalaryTabDto createdSalary = this.salaryTab_Service.createSalary(salaryTabDto,pid);
	...
	//update
	@PutMapping("/{salaryId}")
	public ResponseEntity<ApiResponse>updateSalaryDetails(@RequestBody SalaryTabDto salaryTabDto,
	...
	public ResponseEntity<ApiResponse>deleteById(@PathVariable Long salaryId){
