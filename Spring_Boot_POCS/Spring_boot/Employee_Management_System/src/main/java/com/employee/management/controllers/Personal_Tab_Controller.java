...
import com.employee.management.services.PersonalTab_Service;
import com.employee.management.utils.File_Encoder_Decoder;
...
public class Personal_Tab_Controller {
	...
	@PostMapping(path = "/add/{userId}", consumes = { MediaType.MULTIPART_FORM_DATA_VALUE,
	...
	private ResponseEntity<ApiResponse> createPerson(@Valid @RequestPart("json") PersonalDTO personalDetails,
		...
		this.personal_service.createPersonal(personalDetails,userId);
...
//    private ResponseEntity<PersonalDTO> createPerson(@Valid @RequestBody PersonalDTO personalDetails,
//    		@PathVariable Integer userId) throws IOException {
//        PersonalDTO createPersonal = this.personal_service.createPersonal(personalDetails,userId);
//		return new ResponseEntity<PersonalDTO>(createPersonal,HttpStatus.CREATED);
//
//	}
	

	@PutMapping(path = "/{personId}")
	public ResponseEntity<ApiResponse> updatePerson(@Valid @RequestBody PersonalDTO personalDetails,@PathVariable Long personId) throws Exception {

		PersonalDTO updatePersonal = this.personal_service.updatePersonal(personalDetails, personId);
        return new ResponseEntity<ApiResponse>(new ApiResponse("Person updated Successfully!", true), HttpStatus.OK);
