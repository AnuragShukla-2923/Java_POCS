...
//	}
	...
	public ResponseEntity<SkillTabDto>createSkill(@RequestBody SkillTabDto Skills,
			@PathVariable Long pid){
		SkillTabDto createdSkills = this.skillTab_Service.createSkills(Skills,pid);
		return new ResponseEntity<SkillTabDto>(createdSkills,HttpStatus.CREATED);
	}
	
	//UpdateSkills
	@PutMapping("/{skillsId}")
	public ResponseEntity<ApiResponse>updateSkill(@RequestBody SkillTabDto Skills,@PathVariable Long skillsId){
		SkillTabDto createdSkills = this.skillTab_Service.updateSkills(Skills,skillsId);
		return new ResponseEntity<ApiResponse>(new ApiResponse("Skill Updated Successfully!",true),HttpStatus.OK);
	}
